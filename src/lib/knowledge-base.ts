...
const predefinedChecklistItems: PredefinedChecklistItem[] = [
  ...
  },
  {
    ...
    text: 'Weekly Report',
    subItems: [
      { text: 'Compile sales data' },
      { text: 'Analyze key metrics' },
      { text: 'Write executive summary' },
      { text: 'Get it reviewed by manager' },
    ],
  },
  {
    key: 'project_kickoff',
    ...
    subItems: [
      ...
      { text: 'Assign roles and responsibilities' },
      { text: 'Establish timeline' },
      { text: 'Set up communication channels' },
    ],
  },
  {
    key: 'new_feature_qa',
