...
export function SwipeableItem({
  ...
  return (
    <div ref={containerRef} className="relative flex-1 touch-manipulation overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-stretch justify-between">
        ...
        <div className="flex h-full items-center bg-accent px-6">
        ...
        <button
          ...
          className="pointer-events-auto flex h-full items-center justify-center bg-destructive transition-colors active:bg-destructive/80"
