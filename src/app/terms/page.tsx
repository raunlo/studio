      ...
      <div className="container mx-auto max-w-3xl p-4 sm:p-8">
        ...
        <div className="prose prose-stone dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              By accessing or using Daily Chexly (&quot;the Service&quot;), you agree to be bound by these
              Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, do not use the Service.
            </p>
            <p>
              We may modify these Terms at any time. Continued use after changes constitutes acceptance
              of the modified Terms. We will notify you of material changes via the application or email.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">3.1 Google Sign-In</h3>
            <p>
              You must sign in with a valid Google account to use the Service. By signing in,
              you authorize us to access certain information from your Google account as described
              in our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>.
            </p>

            <h3 className="text-xl font-medium mt-4">3.2 Account Responsibility</h3>
          ...
          <section>
            ...
            <p>
              &quot;User Content&quot; means any content you create, upload, or enter into the Service,
              including checklist names, descriptions, items, and rows. You retain ownership of
              your User Content.
            </p>

            <h3 className="text-xl font-medium mt-4">4.2 License to Us</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mt-4">4.3 Content Responsibility</h3>
            ...
            <h3 className="text-xl font-medium mt-4">4.4 Content Guidelines</h3>
            <p className="bg-muted p-3 rounded-md">
              <strong>Free Text Fields:</strong> Checklist names, descriptions, and items are free
              text fields. You may enter any content, but you are responsible for what you store.
              We recommend not storing sensitive information like passwords, financial data, or
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">6.1 Sharing Checklists</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mt-4">6.2 Shared Content Responsibility</h3>
            <p>
              You are responsible for content you share. Do not share content that others should
              not see, and do not share checklists containing sensitive information about third parties.
            </p>

            <h3 className="text-xl font-medium mt-4">6.3 Invite Links</h3>
            <p>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">7.1 Our Intellectual Property</h3>
            <p>
              The Service, including its design, features, code, and branding, is owned by
              Daily Chexly and protected by intellectual property laws. You may not copy, modify,
              distribute, sell, or lease any part of the Service.
            </p>

            <h3 className="text-xl font-medium mt-4">7.2 Feedback</h3>
            <p>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">8.1 No Guarantee</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mt-4">8.2 Modifications</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mt-4">8.3 Data Backup</h3>
            <p>
              While we maintain backups, you are encouraged to export your data regularly.
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">9.1 By You</h3>
            <p>
              You may stop using the Service and delete your account at any time through the
              account settings. Upon deletion, all your data will be permanently removed.
            </p>

            <h3 className="text-xl font-medium mt-4">9.2 By Us</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mt-4">9.3 Effect of Termination</h3>
            <p>
              Upon termination, your right to use the Service ceases immediately. Sections that by
              their nature should survive termination will survive (including limitation of liability,
          ...
          <section>
            ...
            <p className="bg-muted p-3 rounded-md font-mono text-sm">
          ...
          <section>
            ...
            <p className="bg-muted p-3 rounded-md font-mono text-sm">
              ...
              NOT LIMITED TO LOSS OF DATA, PROFITS, OR GOODWILL, ARISING OUT OF OR RELATED TO
            ...
            <p className="mt-2">
              Some jurisdictions do not allow limitation of liability for certain damages, so
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">13.1 Governing Law</h3>
            <p>
              These Terms shall be governed by and construed in accordance with the laws of
              Spain, without regard to conflict of law principles.
            </p>

            <h3 className="text-xl font-medium mt-4">13.2 Dispute Resolution</h3>
            <p>
              Any disputes arising from these Terms or the Service shall first be attempted to
              be resolved through good-faith negotiation. If negotiation fails, disputes shall
              be resolved through binding arbitration or in the courts of Spain.
            </p>

            <h3 className="text-xl font-medium mt-4">13.3 Class Action Waiver</h3>
            <p>
              You agree to resolve disputes with us on an individual basis. You waive the right
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mt-4">14.1 Entire Agreement</h3>
            <p>
              These Terms, together with our Privacy Policy, constitute the entire agreement
              between you and Daily Chexly regarding the Service.
            </p>

            <h3 className="text-xl font-medium mt-4">14.2 Severability</h3>
            <p>
              If any provision of these Terms is found unenforceable, the remaining provisions
              will continue in effect.
            </p>

            <h3 className="text-xl font-medium mt-4">14.3 Waiver</h3>
            <p>
              Our failure to enforce any right or provision does not constitute a waiver of
              that right or provision.
            </p>

            <h3 className="text-xl font-medium mt-4">14.4 Assignment</h3>
            <p>
              You may not assign your rights under these Terms. We may assign our rights to
              any affiliate or successor.
            </p>

            <h3 className="text-xl font-medium mt-4">14.5 Force Majeure</h3>
            <p>
              We shall not be liable for any failure to perform due to causes beyond our
              reasonable control, including natural disasters, war, terrorism, riots, embargoes,
          ...
          <section>
            ...
            <p>
              Daily Chexly is operated by an individual based in Spain (European Union).
            </p>
            <p className="mt-2">
          ...
          <section className="bg-muted p-4 rounded-lg">
            ...
            <p className="mt-2">
              ...
              your content but give us permission to store and display it. Don&apos;t use the Service
              for illegal purposes. We provide the Service &quot;as is&quot; without guarantees. These Terms
